...
const CHANGELOG_DATA = [
    {
        ...
        "entries": [
            ...
            },
            {
                ...
                "bodyHtml": "<p class=\"text-sm text-text-light-muted dark:text-text-dark-muted mb-3\">Added and upgraded 4 Backlog papers for CSE-AIML 2025-29.</p><div><h4 class=\"text-xs font-bold text-primary mb-2\">Sem 1</h4><ul class=\"text-xs text-text-light-muted dark:text-text-dark-muted space-y-1\"><li>• Programming in C</li><li>• Linear Algebra</li><li>• Digital Electronics and Logic Design</li><li>• Chemistry</li></ul></div>"text-sm text-text-light-muted dark:text-text-dark-muted\">Added two new papers (Programming in C and Linear Algebra) and fully upgraded the Chemistry and Digital Electronics papers to high-quality versions for the SIT Hyderabad CSE-AIML 2025-29 batch (Semester 1).</p>"
            },
            {
                "date": "Sep 14, 2026",
                "color": "indigo",
                ...
                "bodyHtml": "<p class=\"text-sm text-text-light-muted dark:text-text-dark-muted mb-3\">Added 1 new paper and upgraded 3 existing Backlog papers for CSE 2025-29.</p><div><h4 class=\"text-xs font-bold text-primary mb-2\">Sem 1</h4><ul class=\"text-xs text-text-light-muted dark:text-text-dark-muted space-y-1\"><li>• Programming Paradigm and Problem Solving</li><li>• Fundamentals of Quantum Physics</li><li>• Digital Electronics and Logic Design</li><li>• Calculus</li></ul></div>"text-sm text-text-light-muted dark:text-text-dark-muted\">Added a brand new paper (Programming Paradigm and Problem Solving) and upgraded 3 existing Backlog papers to high-quality versions for the SIT Hyderabad CSE 2025-29 batch (Semester 1).</p>"
            },
            {
                "date": "Sep 14, 2026",
                "color": "indigo",
